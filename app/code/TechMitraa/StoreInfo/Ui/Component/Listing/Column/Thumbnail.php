        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                if ($item['image']) {
                    ...
                    // please place your placeholder image at pub/media/techmitraa/storeinfo/placeholder/placeholder.jpg
                    $item[$fieldName . '_src'] = $path.'techmitraa/storeinfo/placeholder/placeholder.jpg';
                    $item[$fieldName . '_alt'] = 'Place Holder';
                    $item[$fieldName . '_orig_src'] = $path.'techmitraa/storeinfo/placeholder/placeholder.jpg';
                }
            }
        }
